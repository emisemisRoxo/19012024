// declaração da classe/objeto 'IntergerTypeComentado'
public class IntergerTypeComentado {
    ...
    public static void main (String[] args) {
        //declaração de variável 'intVar', a qual tem valor de (=) '202345767'.
        int intVar = 202345767;
         //Impressão na tela da seguinte variável 'intVar'.
        System.out.println(intVar);
    }//fechamento do método executor 'main'.
}//fechamento do objeto 'IntergerTypeComentado'.
